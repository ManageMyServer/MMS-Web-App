<h2 class="text-center">MySQL <small>The Vanilla Server</small></h2>
<div class="row">
<div class="col-xs-3">
...
<div class="form-group">
   ...
   <label class="control-label">MySQL address</label>
   <input disabled type="text" class="form-control" placeholder="MySQL Address" value="127.0.0.1">

   <label class="control-label">MySQL Username</label>
   <input disabled type="text" class="form-control" placeholder="MySQL Username" value="server1">

   <label class="control-label">MySQL Password</label>
   <div class="input-group">
   <input disabled type="text" class="form-control" placeholder="MySQL Password" value="j7o1pk2">
   <span class="input-group-btn">
       <button class="btn btn-raised btn-danger" type="button">Get New Password</button>
   </span>
   </div>
</div>
<div class="btn-group" role="group">
   <a href=""><button type="button" class="btn btn-primary">Access PHPMyAdmin (Comming Soon)</button></a>
</div>
</div>
</div>
