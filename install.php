...
');
       ...
       //Create tables
       $sql = 'CREATE TABLE '.$config['table_prefix'].'_nodes ( `ID` int NOT NULL AUTO_INCREMENT UNIQUE, `ip` TEXT, `name` TEXT NOT NULL , `online` INT NOT NULL , `port` INT NOT NULL, `ports` TEXT, PRIMARY KEY (ID) )';
