...
');
   ...
   password VARCHAR(30) NOT NULL
    ...
    <footer>
        <br />
        <hr />
        <p class="pull-right">This installer was made by ManageMyServer.</p>
        <a href="https://github.com/managemyserver/">
            &copy; ManageMyServer <?php echo date("Y"); ?>
        </a>
    </footer>
</body>